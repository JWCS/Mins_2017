 ...
 * For the moment, holds common public methods.
 * Some of these 'common methods' might make use of 'common data' in RobotCode.
 */


public class Methods {
    static RobotController rc = RobotCode.rc;
    /**
